    ...
    <div className="legal-page">
      <div className="legal-container">
        ...
        <div className="legal-content">
          ...
          <h3>6. Allgemeine Geschäftsbedingungen</h3>
          <a href="/ONLINE-SHOP-AGB_BASIC.pdf" target="_blank" rel="noopener noreferrer" className="footer-link">PDF-Datei Download</a>
